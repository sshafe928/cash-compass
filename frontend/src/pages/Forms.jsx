...
// even though not used it's needed for data so no errors
...
const Forms = () => {
  ...
  const handleExpenseSubmit = (e) => {
    ...
    axios
      .post("http://localhost:5000/api/forms", dataObj)
      .then((response) => {
  ...
  return (
    <div className="flex min-h-screen bg-bg-gray">
      {/* navbar */}
      <div
        className={`lg:w-1/5 w-[300px] fixed lg:relative bg-dark-blue text-white h-full flex flex-col lg:top-0 transition-transform duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } lg:translate-x-0`}
      ></div>
      <div
        className={`lg:w-1/5 w-[300px] fixed bg-dark-blue text-white p-4 h-screen flex flex-col lg:top-0 transition-transform duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } lg:translate-x-0`}
      >
        <button
        ...
        <ul>
          <li>
            <a
              href="/"
              className="block py-2 px-4 rounded-md hover:bg-hl-blue hover:text-dark-blue"
            >
              Dashboard
            </a>
          </li>
        ...
        {!formActive && (
          <div className="flex flex-col justify-between mx-auto mt-20 gap-10 md:gap-20">
            <div className="flex md:flex-row flex-col gap-10 md:gap-20 mx-auto">
              <button
                className="bg-[url(../assets/images/incomeMobile2.png)] md:bg-[url(../assets/images/income.png)] bg-cover md:bg-cover w-[300px] h-[150px] md:h-[250px] lg:w-[350px] rounded-2xl flex shadow-md hover:shadow-lg transition-shadow duration-200"
                onClick={() => handleOption("income")}
              >
                <h1 className="text-4xl ml-8 mt-6 text-dark-blue">Income</h1>
              </button>
              <button
                className="bg-[url(../assets/images/expenseMobile.png)] md:bg-[url(../assets/images/expense.png)] bg-cover md:bg-cover w-[300px] h-[150px] md:h-[250px] lg:w-[350px] rounded-2xl flex shadow-md hover:shadow-lg transition-shadow duration-200"
                onClick={() => handleOption("expense")}
              >
            ...
            <div className="flex md:flex-row flex-col gap-10 md:gap-20 mx-auto">
              <button
                className="bg-[url(../assets/images/savingsMobile.png)] md:bg-[url(../assets/images/savings2.png)] bg-cover md:bg-cover w-[300px] h-[150px] md:h-[250px] lg:w-[350px] rounded-2xl flex shadow-md hover:shadow-lg transition-shadow duration-200"
                onClick={() => handleOption("savings")}
              >
                <h1 className="text-4xl ml-8 mt-6 text-dark-blue">Savings</h1>
              </button>
              <button
                className="bg-[url(../assets/images/debtMobile.png)] md:bg-[url(../assets/images/debt2.png)] bg-cover md:bg-cover w-[300px] h-[150px] md:h-[250px] lg:w-[350px] rounded-2xl flex shadow-md hover:shadow-lg transition-shadow duration-200"
                onClick={() => handleOption("debt")}
              >
